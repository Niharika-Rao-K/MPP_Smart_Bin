...
export default function App() {
  ...
  const handleUserDeposit = async (e) => {
    ...
    try {
      ...
      /*
       * Store analysis information so the dashboard can
      ...
      setAnalysis({
        ...
        confidence:
          data.fusion_result?.confidence ||
          null,

        explorerUrl:
          data.web3_reward?.explorer_url ||
          null,
      });
      ...
      setErrorMessage(
        err.message ||
        'Unable to evaluate the deposit.'
      );
    } finally {
